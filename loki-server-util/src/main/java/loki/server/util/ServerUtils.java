...
public abstract class ServerUtils
{
	...
	/**
	 * Loads a property map from a property file at the given path on the file system.
	 * 
	...
	/**
     * Prints the specified message to standard output with a timetamp.
     * The output is printed using System.out.println() in the format: [dd-MM-yyyy HH:mm:ss] message.
     * 
     ...
     * The output is printed using System.out.println() in the format: [dd-MM-yyyy HH:mm:ss] throwable.
     * 
