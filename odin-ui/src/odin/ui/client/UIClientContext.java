...
/**
 * The Client Context of the ODIN application.
 * Creates and holds a remote service instance of the DataServiceAsync interface for retrieving statistics data from the server.
