...
public class Element extends Entity
{
     ...
     * Document.getRootDocument().getBody().add(panel);
     * 
     * Element image = new Element("img");
     * image.setAttribute("src", "/static/image.png");
     * panel.add(image);
     * 
     ...
     * Example usage:
     * 
     * Element panel = new Element("div", "panel-nav");
     * Document.getRootDocument().getBody().add(panel);
     * 
     * Element image = new Element("img", "image-large");
     * image.setAttribute("src", "/static/image.png");
     * panel.add(image);
     * 
     * @param tag       The tag to create.
	...
	/**
     * Specifies a click handler for the underlying JS element. 
     * This is called if this element or any of its children are clicked.
     * 
	...
	/**
     * Specifies a click handler for the underlying JS element. 
     * This is called if this element only is clicked; it is not called if one of its children are clicked.
     * 
     * @param runnable          The runnable that is run when the underlying JS element is clicked.
     */
	...
	/**
     * Sets a CSS style value for the underlying JS element.
     * Style names should be specified in the same format they are specified in JavaScript; for example backgroundColor for CSS background-color.
     * 
